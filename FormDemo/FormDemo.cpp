...
// FormDemo.cpp: определяет поведение классов для приложения.
//
...
// Единственный объект CFormDemoApp

CFormDemoApp theApp;


// Инициализация CFormDemoApp
...
// Обработчики сообщений CFormDemoApp
